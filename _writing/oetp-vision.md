...
```
   ...
   Answer Key Hash ──► Anchored to ledger ──► Results published
...
You can find the code implementation for OETP [here](https://github.com/elrensmin/oetp)

It's released under the MIT license so feel free to mod it, expand it, fork it and improve it. 
